...
function MainContentArea(props: { project: State<IProjectModel> }) {
    ...
    return (
        <Container fluid className="container-xxl">
            <Row>
                <PageSideNav
                    buildSteps={props.project.build_steps
                        .get()
                        .map((bs) => bs.name)}
                ...
                <Col lg={8} className="ms-lg-auto px-md-4">
                    <div className="d-flex flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <div className="ml-auto">
                            Created By: <a href="#">Troy Joachim</a> on {localizeDateTime(props.project.creation_datetime.get())}
                            <Button
                                variant="primary"
                                size="sm"
                                className="ml-2 mb-2"
                        ...
                        <Route exact path={path}>
                            <Card>
                                <Card.Body>
                                    ...
                                    <Description
                                        text={props.project.description.get()}
                                    />
                                </Card.Body>
                            </Card>
                        </Route>
                        ...
                        <Route path={`${path}/files`}>
                            <Card>
                                <Card.Body>
                                    ...
                                    <FileList
                                        files={props.project.file_attachments.get()}
                                    />
                                </Card.Body>
                            </Card>
                        </Route>
    ...
    function imageCardCategory() {
        switch (category.get()) {
            ...
            case "img-files":
                return (
                    <ImageCardFiles
                        files={props.buildStep.file_attachments.get()}
                    />
                );
